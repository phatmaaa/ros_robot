...
class RobotKinematics:
    ...
    The TF tree provides a convenient way to track the relative positions and orientations
    of objects, sensors,  and other elements in a robotic system.
    By traversing the tree, it is possible to transform coordinates from one frame to another, 
    allowing for coordinate transformations and sensor fusion.
    """
    def __init__(self):
